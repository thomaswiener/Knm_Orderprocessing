...
class Knm_Orderprocessing_Adminhtml_OrderprocessingController extends Mage_Adminhtml_Controller_action
{
	...
	public function editAction() {
		...
		$model  = Mage::getModel('orderprocessing/orderprocessing')->load($id);
		...
		if ($model->getId() || $id == 0) {
			...
			Mage::register('orderprocessing_data', $model);

			$this->loadLayout();
			$this->_setActiveMenu('orderprocessing/items');
			...
			$this->_addContent($this->getLayout()->createBlock('orderprocessing/adminhtml_orderprocessing_edit'))
				->_addLeft($this->getLayout()->createBlock('orderprocessing/adminhtml_orderprocessing_edit_tabs'));
